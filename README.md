...
| **Lab 5** | **DNN on MNIST** | (1) `lab5_mnist.c` – fixed-point MNIST inference (784→64→32→10, Q8.8) on ARM Cortex-A9 with UART-based image input <br> (2) `lab5_mnist_custom_TIPS.c` – custom Group 4 DNN (784→64→32→16→10) with UART and data-representation optimizations (TIP 1: Q0.8 images, TIP 2: Q1.7 weights) <br> with performance analysis – end-to-end and phase-level timing (RX / DNN / PRINT / ITER) using ARM Global Timer |
