...
<p align="center">
  <i>From left to right: original image, negative transformation, histogram stretching, histogram equalization</i>
</p>


* The processing is performed on **PPM (P6) images** received via UART.
* Images shown above are converted to `.png` **only for visualization in this README**.
* The original `.ppm` output files generated by the program are included in the repository.
