...
with open("../weights_group4.h", "w") as out:
  ...
  #  out.write(" * Baseline Q8.8 + Tip 2 Q1.7\n")
    ...
    # ===== FC0 =====
    bin_to_define("../group_4/weights/Gemm0_biases.bin", "bias0", out, "FC0 bias: 64")
    bin_to_define_q17("../group_4/weights/Gemm0_biases.bin", "bias0", out,
                     "FC0 bias: 64")

    bin_to_define("../group_4/weights/Gemm0_weights.bin", "weights0", out, "FC0 weights: 784 x 64")
    bin_to_define_q17("../group_4/weights/Gemm0_weights.bin", "weights0", out,
                    "FC0 weights: 784 x 64")

    # ===== FC1 =====
    bin_to_define("../group_4/weights/Gemm1_biases.bin", "bias1", out, "FC1 bias: 32")
    bin_to_define_q17("../group_4/weights/Gemm1_biases.bin", "bias1", out,
                      "FC1 bias: 32")

    bin_to_define("../group_4/weights/Gemm1_weights.bin", "weights1", out, "FC1 weights: 64 x 32")
    bin_to_define_q17("../group_4/weights/Gemm1_weights.bin", "weights1", out,
                      "FC1 weights: 64 x 32")

    # ===== FC2 =====
    bin_to_define("../group_4/weights/Gemm2_biases.bin", "bias2", out, "FC2 bias: 16")
    bin_to_define_q17("../group_4/weights/Gemm2_biases.bin", "bias2", out,
                      "FC2 bias: 16")

    bin_to_define("../group_4/weights/Gemm2_weights.bin", "weights2", out, "FC2 weights: 32 x 16")
    bin_to_define_q17("../group_4/weights/Gemm2_weights.bin", "weights2", out,
                      "FC2 weights: 32 x 16")

    # ===== FC3 =====
    bin_to_define("../group_4/weights/Gemm3_biases.bin", "bias3", out, "FC3 bias: 10")
    bin_to_define_q17("../group_4/weights/Gemm3_biases.bin", "bias3", out,
                      "FC3 bias: 10")

    bin_to_define("../group_4/weights/Gemm3_weights.bin", "weights3", out, "FC3 weights: 16 x 10")
